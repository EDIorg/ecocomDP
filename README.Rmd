...
You can install the released version of ecocomDP from [CRAN](https://CRAN.R-project.org) with:
...
Repository specific methods can be added by contacting the project maintainer.
