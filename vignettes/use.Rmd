...
```{r}
flat <- flatten_data(dataset_1[[1]]$tables)
flat
...
plot_taxa_accum_time(dataset_1)

plot_taxa_diversity(dataset_1)
plot_taxa_diversity(data = dataset_1, 
...
plot_sample_space_time(dataset_1)

plot_taxa_shared_sites(dataset_1)

plot_taxa_rank(data = dataset_1, 
