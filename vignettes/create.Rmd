...
create_ecocomDP <- function(path,
  ...
  # The hard work is done! The flat master source table is complete and we can now use the "create" functions to parse it into the ecocomDP tables. Each ecocomDP table has an associated create function.
  ...
  eml <- ecocomDP::create_eml(
    path = path,
    source_id = package.id.L0,
    derived_id = package.id.L1,
