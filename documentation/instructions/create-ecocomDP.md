...
The location and taxon tables are most likely to come first, but could be in either order, as they are equal parents of observation. A minimum of 4 tables is required (ie, if there is no ancillary information to include).
