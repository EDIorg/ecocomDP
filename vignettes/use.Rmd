...
```{r}
flat <- flatten_data(tables = datasets[[1]]$tables)
flat

flat <- flatten_data(dataset = datasets)
flat

flat <- flatten_dataset(datasets)
flat

flat <- flatten_tables(datasets[[1]]$tables)
flat
```
...
plot_taxa_accum_time(dataset = dataset_1)
plot_taxa_accum_time(flat_data = flatten_dataset(dataset_1))

plot_taxa_richness(dataset = dataset_1)
plot_taxa_richness(dataset = dataset_1, 
...
plot_sample_space_time(dataset = dataset_1)

plot_taxa_shared_sites(dataset = dataset_1)

plot_taxa_rank(flat_data = flatten_dataset(dataset_1), 
