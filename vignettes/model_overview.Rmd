...
vignette: >
  %\VignetteIndexEntry{model_overview}
...
*   [The authoritative set of table descriptions, relationships, and requirements](#main)
    *   [Tables](#tables)
...
*   [A visualization of table contents and relationships](#vis)
...
---
# Visualization of table contents and relationships {#vis}
